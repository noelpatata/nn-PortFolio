...
const CustomCarIcon = React.memo(
  React.forwardRef<SVGSVGElement, SVGRProps>(props => {
    return (
...
CustomCarIcon.displayName = 'CustomCarIcon'; // Helpful for debugging

export default CustomCarIcon;
